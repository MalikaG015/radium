...
const createBook = async function (req, res) {
    try {
       ...
       // for line 38 to execute after ! should be false-->!false=true 
        ...
        let { title,bookCover, excerpt, userId, ISBN, category, subcategory, reviews, releasedAt } = requestBody
        ...
        const updatedBody = { title, bookCover, excerpt, userId, ISBN, category, subcategory, reviews, releasedAt }
...
module.exports = {
    createBook, getBooks, getBooksByID, updateBooks, deleteByBookId,uploadImage
}